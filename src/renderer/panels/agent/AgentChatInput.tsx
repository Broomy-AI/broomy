    ...
    <div className="border-t border-neutral-700 bg-neutral-900 px-3 py-2">
      ...
      <div className="flex items-end gap-2">
        <textarea
          ...
          rows={1}
          className="flex-1 resize-none rounded border border-neutral-600 bg-neutral-800 px-3 py-2 text-sm text-neutral-200 placeholder-neutral-500 focus:border-info-base focus:outline-none"
        />
        {isRunning ? (
          <>
            <button
      ...
      {availableModels && availableModels.length > 0 && (
        <div className="mt-1.5 flex items-center gap-1.5">
          ...
          <select
            ...
            className="rounded border border-neutral-700 bg-neutral-800 px-2 py-0.5 text-xs text-neutral-300 hover:border-neutral-500 focus:border-info-base focus:outline-none"
          >
