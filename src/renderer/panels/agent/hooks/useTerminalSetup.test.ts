    ...
    it('fits and focuses terminal when becoming active via store', () => {
      ...
      useSessionStore.setState({
        ...
        sessions: [{
          ...
          branchStatus: 'in-progress' as const, hasFeedback: false, checksStatus: 'none' as const, statusChip: 'in-progress' as StatusChip, isArchived: false, stage: 'new', isRestored: false,
        }],
      })
      const config = makeConfig()
      const containerRef = makeContainerRef()
