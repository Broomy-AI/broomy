...
function UpdateBannerReady() {
  return (
    <div className="mx-2 mt-2 px-2.5 py-1.5 rounded bg-green-500/10 border border-green-500/20 flex items-center gap-2">
      ...
      <button className="text-3xs font-medium px-1.5 py-0.5 rounded bg-green-600 text-white hover:bg-green-600/80 transition-colors flex-shrink-0">Restart</button>
    </div>
  )
}
