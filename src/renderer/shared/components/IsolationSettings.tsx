    ...
    <>
      <div className="space-y-2">
        <label className="flex items-center gap-2 cursor-pointer">
          ...
          <span className="px-1.5 py-0.5 text-3xs font-semibold uppercase tracking-wider rounded bg-yellow-500/20 text-yellow-400 border border-yellow-500/30">Experimental</span>
        </label>
        {isolated && (
